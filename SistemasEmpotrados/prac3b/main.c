...
int main() {
	...
	// COMPLETAR instalando como manejador de la interrupción de nivel 2
	// la rutina uart_rx_irq_handler siguiendo el mismo patrón de la prac3a
	...
	// COMPLETAR habilitando las interrupciones y desenmascarando la interrupción de nivel 2
