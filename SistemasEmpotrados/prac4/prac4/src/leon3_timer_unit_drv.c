...
uint8_t leon3_timer_config(uint8_t timerId
	...
	if(timerId < LEON3_TIMER_UNIT_TIMERS ){
		...
		//TODO
		//Configurar el campo chain_with_prec_timer del timerId (sin cambiar el resto de campos de Ctrl)
		//que fija el encadenamiento con el timer anterior
		...
		//TODO
		//Configura el campo Restart del timerId (sin cambiar el resto de campos de Ctrl) que determina si debe
		//reiniciarse el timer tras el underflow
		//Usa las máscaras definidas en LEON3 Timer Ctrl Masks
