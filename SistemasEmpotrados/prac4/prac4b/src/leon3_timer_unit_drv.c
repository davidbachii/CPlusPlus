...
void leon3_timerunit_set_configuration( uint32_t scalerValue, bool_t timer_freeze_during_debug, bool_t separate_interrupts ){
...
uint8_t leon3_timer_config(uint8_t timerId, uint32_t timerValue, bool_t chain_with_prec_timer, bool_t restart_timer){
	...
	if(timerId < LEON3_TIMER_UNIT_TIMERS ){
		...
		// OJO, te falta poner el valor del registro de recarga
